...
const MyAppointments = () => {
  const { backendUrl, token, getDoctosData, userId } = useContext(AppContext)
  ...
  const initPay = (order, appointmentId) => {
      const options = {
          ...
          handler: async (response) => {
              try {
                  const { data } = await axios.post(backendUrl + "/api/user/verifyRazorpay", { ...response, appointmentId }, { headers: { token } });
                  if (data.success) {
